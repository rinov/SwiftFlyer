...
public final class PostIFDOCOOrderRequest: Requestable {
    ...
    public var httpBody: Data? {
        ...
        json.appendingQueryParameter(key: "order_method", value: ParentOrderType.ifdoco)
